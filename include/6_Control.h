...
#ifdef local_enable
  #define pin_raise  0  // Wemos GPIO0  = D3 pin to raise T_sp in Auto, or heater on in Man (embedded pull up, active low).
  #define pin_lower  2  // Wemos GPIO2  = D4 pin to lower T_sp in Auto, or heater off in Man (embedded pull up, active low).
